...
import type { Condition, UUID, AnimationID, Script, ScriptInstance, ScriptDataInstanceType } from '@/types';
...
export function ConditionNode({ path, condition, updateCondition, deleteNode }: ConditionNodeProps) {
