...
export function ToggleGroupControls({
	selectedGroupUUID,
	onGroupChange,
}: ToggleGroupControlsProps) {
		...
		<>
			<div className="flex items-center gap-2">
				<div className="relative flex-grow">
					...
					{selectedGroupUUID && (
						<Button
							...
							className="absolute right-1 top-1/2 -translate-y-1/2 h-8 w-8 p-0 bg-transparent hover:bg-slate-700"
						>
				...
				<Button
					...
					className="bg-violet-600 hover:bg-violet-500 flex-shrink-0 w-10 h-10 p-0"
				>
