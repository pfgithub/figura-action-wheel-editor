...
export function ScriptsManager() {
	...
	const selectedScript = selectedScriptId
		? avatar.scripts[selectedScriptId]
		: null;
	...
	return (
		<div className="flex flex-col md:flex-row gap-6 h-full">
				...
				{selectedScript ? (
					<div>
						<div className="flex justify-between items-center mb-4 pb-3 border-b border-slate-700">
							...
							<Button
								onClick={() => setDeletingScriptId(selectedScript.uuid)}
					...
					<div className="flex flex-col items-center justify-center h-full text-slate-500">
						...
						<p className="text-sm">
							Choose a script from the list, or add a new one.
						</p>
					</div>
				)}
			</div>
			...
			<ConfirmationDialog
				...
				message={
					<>
						Are you sure you want to delete this script and all its instances?
